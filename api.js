      ...
      if (data.success) {
        showAlert(
          `<strong>Booking Request Received!</strong><br>
           Thank you, ${first_name}! We have received your booking request and will contact you at <strong>${phone}</strong> to confirm.`,
          'success'
        );
        form.reset();
      } else {
      ...
      if (data.success) {
        showAlert(
          `<strong>Cargo Request Submitted!</strong><br>
           ...
           <small class="text-muted">Save this ID to track your shipment on the tracking page.</small>`,
          'success'
        );
        form.reset();
      } else {
